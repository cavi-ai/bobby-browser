...
const OPERATION_SUPPORT: [OperationSupport; 20] = [
    ...
    OperationSupport::new(InterfaceOperation::CreateCheckpoint, D, D, D, D, BROWSERS),
    OperationSupport::new(InterfaceOperation::ReadCheckpoint, D, D, D, D, BROWSERS),
    OperationSupport::new(InterfaceOperation::RecoverWorkflow, D, D, U, D, BROWSERS),
    OperationSupport::new(InterfaceOperation::ReadArtifact, D, U, U, U, RUNTIME),
    OperationSupport::new(InterfaceOperation::ReadContext, D, D, U, D, BROWSERS),
