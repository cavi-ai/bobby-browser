...
| `a11y_snapshot` | `browser:mutate` | Capture a compact accessibility tree with bounded form-control state and sensitive-value redaction (`maxNodes` optional, 1…2048; default 256) |
