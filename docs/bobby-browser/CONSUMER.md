...
documentation artifact built for bobby-browser `0.10.0`.

```text
source: GitHub Release asset bobby-browser-docs-v0.10.0.tar.gz
publicBasePath: /docs/bobby-browser/v0.10.0
...
`/docs/bobby-browser/v0.10.0` public base path. Serve `/docs/bobby-browser` as an
...
The manifest version must equal the documented version, `0.10.0`.
